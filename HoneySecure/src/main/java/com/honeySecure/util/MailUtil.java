...
public class MailUtil {
    ...
    public static void sendFakeUserAlertWithAttachment(String toEmail, String filePath) {
    	 ...
    	 if (toEmail == null || filePath == null) {
    	        System.out.println("Error: Email or file path is null in sendFakeUserAlertWithAttachment");
    	        return;
    	    }
        ...
        try {
            ...
            if (!file.exists()) {
                System.out.println("Warning: File not found at path: " + filePath);
